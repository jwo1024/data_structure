...
void deleteArrayList(ArrayList** pList) // delete 이렇게 수정하는건 어떻게 생각하시는지? 
{
...
void displayArrayList(ArrayList* pList)
{
	...
	printf("%d\n", pList->pElement[i].data); // 마지막에 공백 대신 띄어쓰기가 되도록
}
